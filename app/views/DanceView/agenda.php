        ...
        <div class="col-md-7 ">
          ...
          <?php if ($e->getEventDay() === 'Friday'): ?>
              <tr>
                ...
                <td class="Time-duration"><?php echo $e->getEventTime(); ?><br><span class="durationMinutesDay1">(<?php echo $e->getDurationMinutes(); ?> min)</span></td>
      ...
      <div class="col-md-7 ">
          ...
          <?php if ($e->getEventDay() === 'Saturday'): ?>
              ...
              <tr>
                ...
                <td class="Time-duration"><?php echo $e->getEventTime(); ?><br><span class="durationMinutesDay2">(<?php echo $e->getDurationMinutes(); ?> min)</span></td>
                <td class="price">€ <?php echo $e->getSessionPrice(); ?></td>
                <td class="ticketAvailable"><?php echo $e->getSessionsAvailable(); ?></td>
                <td class="column-address"><?php echo $e->getVenueAddress(); ?></td>
              </tr>
          ...
          <table class="table" id="day3-table">
            ...
            <?php foreach ($event as $e): ?>
             <?php if ($e->getEventDay() === 'Sunday'): ?>
              <tr>
                <td class="artist-session"><?php echo $e->getArtistName(); ?></td>
                <td class="Time-duration"><?php echo $e->getEventTime(); ?><br><span class="durationMinutesDay3">(<?php echo $e->getDurationMinutes(); ?> min)</span></td>
                <td class="price">€ <?php echo $e->getSessionPrice(); ?></td>
                <td class="ticketAvailable"><?php echo $e->getSessionsAvailable(); ?></td>
                <td class="column-address"><?php echo $e->getVenueAddress(); ?></td>
              </tr>
