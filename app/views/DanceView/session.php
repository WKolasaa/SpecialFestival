        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 introText">
                    ...
                    <p class="paragraph-text">The Haarlem Festival awaits, and your ticket is just a click away! Dive
                        into a world
                        of incredible music, tracks, and experiences. Don't miss your chance to be part of this
                        extraordinary event.
                        Secure your tickets today and get ready for a festival adventure like no other. Join us in
                        creating memories
    ...
    <div class="container mt-4">
        <div class="row">
            <div class="col-md-12 d-flex flex-column align-items-end">
                <!-- Change to flex-column and add align-items-end -->
                <nav>
