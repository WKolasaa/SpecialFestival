    ...
    <div class="locations-container">
        ...
        <a href="HistoryMain/windmill" class="location-item">
            <div class="location-image-container">
                ...
                <img src="<?= htmlspecialchars($adriaanWindmillImagePath) ?>" alt="Adriaan Windmill"
...
<div class="timeslots-section">
    ...
    foreach ($timeslots as $timeslot):
        ...
        <div class="timeslot">
            ...
            <p><strong>Time:</strong> <?= htmlspecialchars($timeslot['start_time']) ?>
                - <?= htmlspecialchars($timeslot['end_time']) ?></p>
            <div class="languages">
