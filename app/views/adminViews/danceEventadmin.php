                ...
                <div id="add-artist-form" style="display:none;">
                    ...
                    <form id="artistForm" enctype="multipart/form-data" method="POST" class="p-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="new-artist-description" name="description" class="form-control"
                                   required>
                        </div>
                        <div class="mb-3">
            ...
            <div class="modal-content">
                ...
                <div id="add-ticket-form" style="display:none;">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="time" id="new-ticket-startSession" name="startSession" class="form-control"
                               required>
                    </div>
                    <div class="mb-3">
                ...
                <div id="add-overview-form" style="display:none;">
                    ...
                    <form id="overviewForm" enctype="multipart/form-data" method="POST" class="p-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" id="new-overview-image" name="image" class="form-control"
                                   accept="image/*">
                        </div>
                        <button class="btn btn-success" type="submit" name="submit">Submit</button>
                    </form>
