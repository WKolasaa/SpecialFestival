...
class EmailService
{
    public function sendResetTokenEmail($userEmail, $token)
    {
        ...
        $url = 'http://localhost/changepassword?email=' . urlencode($userEmail) . '&token=' . urlencode($token); //TODO: CHANGE HERE FOR LIVE VERSION!
                        ...
                        <td>
                            <table align="center" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                <tbody>
                                    <tr>
                                        <td>
                                            <p style="font-size:16px;line-height:26px;margin:16px 0;font-family:\'Open Sans\', \'HelveticaNeue-Light\', \'Helvetica Neue Light\', \'Helvetica Neue\', Helvetica, Arial, \'Lucida Grande\', sans-serif;font-weight:300;color:#404040">Hi ' . htmlspecialchars($userEmail) . ',</p>
                                            <p style="font-size:16px;line-height:26px;margin:16px 0;font-family:\'Open Sans\', \'HelveticaNeue-Light\', \'Helvetica Neue Light\', \'Helvetica Neue\', Helvetica, Arial, \'Lucida Grande\', sans-serif;font-weight:300;color:#404040">Someone recently requested a password change for your Haarlem Festival account. If this was you, you can set a new password here:</p>
                                            <a href="' . htmlspecialchars($url) . '" style="background-color:#007ee6;border-radius:4px;color:#fff;font-family:\'Open Sans\', \'Helvetica Neue\', Arial;font-size:15px;text-decoration:none;text-align:center;display:inline-block;width:210px;padding:14px 7px 14px 7px;line-height:100%;max-width:100%" target="_blank">
                                                Reset password
                                            </a>
